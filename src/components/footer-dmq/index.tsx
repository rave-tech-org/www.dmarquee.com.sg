        ...
        <div className="component-wrapper">
          <section className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center">
            <section className="space-y-2 max-md:text-center">
              <PortableText value={desc?.customAttributes?.find((e) => e.key === 'header')?.description ?? []} />
            </section>
            <header className="md:col-span-2 max-md:text-center">
              <PortableText value={desc?.description ?? []} />
            </header>
          </section>
        </div>
      </div>
